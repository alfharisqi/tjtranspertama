                            ...
                            <div class="testimony-wrap py-4">
                                <div class="text">
                                    ...
                                    <p class="mb-4">Aplikasinya cepat dan mudah digunakan. Tidak sulit untuk dimengerti.
                                        Saya rekomendasikan para pencari tiket pesawat untuk menggunakan aplikasi Sonic
                                        ini.</p>
                                    <div class="d-flex align-items-center">
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                ...
                                <li><a href="#"><span class="icon fa fa-paper-plane"></span><span
                                            class="text">sonic.fikridean.my.id</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
