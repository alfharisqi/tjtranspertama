...
class ThrottleRequests
{
    ...
    protected function resolveRequestSignature($request)
    {
        ...
        // Jika tidak ada pengguna atau rute yang ditemukan,
        // kembalikan tanda tangan berdasarkan URL dan metode
        return $this->formatIdentifier($request->url().'|'.$request->method());
    }
